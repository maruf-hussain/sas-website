...
const Donate = () => {
  ...
  <img class='w-50' src='https://cdn.hospedagemdesit.es/wp/wp-content/uploads/2016/09/como-criar-formulario-de-contato-no-wordpress.jpg' alt='img'></img>
...
<input type="text" id="email" name="email" placeholder="Your Email.."></input><br/>

<label for="telephone">Phone Number</label><br/>
<input type="telephone" id="telephone" name="telephone" placeholder="Your Phone Number.."></input><br/>
...
<option value="Afghanistan">Afghanistan</option>
      ...
      <option value="Korea, Democratic People's Republic of">Korea South</option>
      <option value="Korea, Republic of">Korea North f</option>
      ...
      <option value="Libyan Arab Jamahiriya">Libyan</option>
